...
export function SectionHeader({ icon, title, color, clause, requirement }: { icon: ReactNode; title: string; color: string; clause?: string; requirement?: string }) {
  return (
    <div>
      ...
      {requirement && (
        <p className="text-[11px] text-slate-400 mt-1 ml-6 leading-relaxed">{requirement}</p>
      )}
    </div>
  )
}
