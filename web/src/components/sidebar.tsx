...
export type ViewType = 'home' | 'unprocessed' | 'upcoming'
...
export default function Sidebar({
  ...
  return (
    <aside className={`${collapsed ? 'w-16' : 'w-56'} bg-slate-800 text-white flex flex-col shrink-0 transition-all duration-200`}>
      {/* 로고 */}
